      ...
      <div>
        <header className='home-header'>
          <nav className='header-nav clearfix'>
            <h2>
              <a href="/">
               <img name='white logo' src={'https://s3-us-west-1.amazonaws.com/scarebnbprod/logo_ghost.png'} height='50' />
              </a>
            </h2>
            <Account />
          </nav>
          ...
          <ul className='home-listings clearfix'>
            <li>
              <Link to='listings/San Francisco, CA'>
                <img name='goldengate' src={'https://s3-us-west-1.amazonaws.com/scarebnbprod/goldengate.jpg'} height='300' width='330' />
            ...
            <li>
              <Link to='listings/Oakland, CA'>
                <img src={'https://s3-us-west-1.amazonaws.com/scarebnbprod/haunted_house.jpg'} height='300' width='330' />
            ...
            <li>
              <Link to='listings/Berkeley, CA'>
                <img src={'https://s3-us-west-1.amazonaws.com/scarebnbprod/hand.jpg'} height='300' width='330' />
            ...
            <li>
              <Link to='listings/Marin County, CA'>
                <img src={'https://s3-us-west-1.amazonaws.com/scarebnbprod/castle.jpg'} height='300' width='330' />
            ...
            <li>
              <Link to='listings/Daly City, CA'>
                <img src={'https://s3-us-west-1.amazonaws.com/scarebnbprod/haunted_house_by_nassimhasan-d5qmcqh.jpg'} height='300' width='330' />
            ...
            <li>
              <Link to='listings/South San Francisco, CA'>
                <img src={'https://s3-us-west-1.amazonaws.com/scarebnbprod/southsanfran.jpg'} height='300' width='330' />
