    ...
    if (!this.state.listing.title) {
      ...
      var listing = this.state.listing,
          ...
          userPictureUrl = (listing.user_picture) ?
                            ...
                            "http://res.cloudinary.com/" + window.CLOUDINARY_CLOUD_NAME + "/image/upload/v1448399277/no-profile-img_vqxn7j.gif";
        return(
          <div>
              ...
              <section className='listing-header-detail clearfix'>
                ...
                <div id='listing-header-info'>
                  ...
                  <div className='header-amenities clearfix'>
                    <div>
                      <img src={'http://res.cloudinary.com/' + window.CLOUDINARY_CLOUD_NAME + '/image/upload/v1447811048/tombstone_qdota8.png'} height='40' />
                      nearby cemetary
                    </div>

                    <div>
                      <img src={'http://res.cloudinary.com/' + window.CLOUDINARY_CLOUD_NAME + '/image/upload/v1447811038/butler_plmuai.png'} height='40' />
                      creepy butler
                    </div>

                    <div>
                      <img src={'http://res.cloudinary.com/' + window.CLOUDINARY_CLOUD_NAME + '/image/upload/v1447811038/children_mc3uu8.png'} height='40' />
                      demented children
                    </div>
                  </div>
                </div>
                ...
                <div id='listing-show-rsvp-content'>
                  <div className='listing-show-rsvp-title clearfix'>
                    <div id='listing-show-rsvp-toenails'>
                      ...
                      <img className='toenail-pic' src={'http://res.cloudinary.com/' + window.CLOUDINARY_CLOUD_NAME + '/image/upload/v1447811047/toenail_on49wz.png'} height='25' />
