...
Picture.create!(listing_id: 1, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/The_Haunted_House_Das_Geisterhaus.jpg')
Picture.create!(listing_id: 2, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/18u67x18rmw7jjpg.jpg')
Picture.create!(listing_id: 3, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/haunted-house.jpg')
Picture.create!(listing_id: 4, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/1415110089999_wps_70_Pic_shows_A_local_artist.jpg')
Picture.create!(listing_id: 5, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/3.jpg')
Picture.create!(listing_id: 6, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/hauntedhouse.jpg')
Picture.create!(listing_id: 7, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/20120429_rtl9992-edit_0.jpg')
Picture.create!(listing_id: 8, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/home_background.jpg')
Picture.create!(listing_id: 9, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/haunted-house-ron-crabb.png')
Picture.create!(listing_id: 10, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/haunted_house_by_nassimhasan-d5qmcqh.jpg')
Picture.create!(listing_id: 11, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/haunted_house_halloween_0_1445254670.jpg')
Picture.create!(listing_id: 12, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/haunted-house_1.jpg')
Picture.create!(listing_id: 13, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/church-in-louisianna-by-rick-galvan-on-flickr.jpg')
Picture.create!(listing_id: 14, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/tumblr_nl12kdzH941s1vn29o1_1280.jpg')
Picture.create!(listing_id: 15, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/342212-haunted-house.jpg')
Picture.create!(listing_id: 16, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/081c7007-d875-8569-2ac6c165aae37f9b.jpg')
Picture.create!(listing_id: 17, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/1520504.jpg')
Picture.create!(listing_id: 18, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/southsanfran.jpg')
Picture.create!(listing_id: 19, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/insane_asylum.jpg')
Picture.create!(listing_id: 20, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/cemetary2.jpg')
Picture.create!(listing_id: 21, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/asylum2.jpg')
Picture.create!(listing_id: 22, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/bathroom.jpg')
Picture.create!(listing_id: 23, url: 'https://s3-us-west-1.amazonaws.com/scarebnbdev/deathstar.jpg')
